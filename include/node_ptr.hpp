...
namespace libconfigfile
{
    ...
    class node_ptr
    {
        ...
        public:
            ...
            explicit node_ptr(ptr_t ptr)
                : m_ptr{ ptr }
            {
            }

            node_ptr(const node_ptr& other)
                : m_ptr{ other.m_ptr->create_clone() }
            {
            }
        ...
        public:
            ...
            template<is_node cast_t>
            node_ptr<cast_t> cast() const
            {
                return node_ptr<cast_t>{ dynamic_cast<decltype(node_ptr<cast_t>{}.m_ptr)>(m_ptr->create_clone()) };
            }
