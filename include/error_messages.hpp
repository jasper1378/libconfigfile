...
// clang-format off
  ...
  static const std::string err_msg_1_2_1 {"/error/syntax/key-value: key-value assignment in missing"};
  static const std::string err_msg_1_2_2 {"/error/syntax/key-value: key-value is empty"};
  static const std::string err_msg_1_2_3 {"/error/syntax/key-value: key-value is unterminated"};
  static const std::string err_msg_1_2_4 {"/error/syntax/key-value: key-value name contains invalid character"};
  static const std::string err_msg_1_2_5 {"/error/syntax/key-value: key-value name is missing"};
  static const std::string err_msg_1_2_6 {"/error/syntax/key-value: key-value name is split by comment(s)"};
  static const std::string err_msg_1_2_7 {"/error/syntax/key-value: key-value name is split by newline"};
  static const std::string err_msg_1_2_8 {"/error/syntax/key-value: key-value value is missing"};
  static const std::string err_msg_1_3_1 {"/error/syntax/string: non-whitespace character appears outside of string"};
  static const std::string err_msg_1_3_2 {"/error/syntax/string: string is split by newline"};
  static const std::string err_msg_1_3_3 {"/error/syntax/string: string is unterminated"};
  static const std::string err_msg_1_4_1 {"/error/syntax/integer: integer contains invalid character"};
  ...
  static const std::string err_msg_1_4_4 {"/error/syntax/integer: integer is split by newline"};
  ...
  static const std::string err_msg_1_5_1 {"/error/syntax/float: float contains invalid character"};
  ...
  static const std::string err_msg_1_5_9 {"/error/syntax/float: float is split by newline"};
  ...
  static const std::string err_msg_1_6_1 {"/error/syntax/array: array element before separator is missing"};
  static const std::string err_msg_1_6_2 {"/error/syntax/array: array element or closing delimiter is missing"};
  static const std::string err_msg_1_6_3 {"/error/syntax/array: array opening delimiter is missing"};
  static const std::string err_msg_1_6_4 {"/error/syntax/array: extraneous character(s) appear after array"};
  static const std::string err_msg_1_7_1 {"/error/syntax/section: extraneous character(s) appear after section name"};
  static const std::string err_msg_1_7_2 {"/error/syntax/section: section body closing delimiter is missing"};
  static const std::string err_msg_1_7_3 {"/error/syntax/section: section body is missing"};
  static const std::string err_msg_1_7_4 {"/error/syntax/section: section body opening delimiter is missing"};
  static const std::string err_msg_1_7_5 {"/error/syntax/section: section name contains invalid character"};
  static const std::string err_msg_1_7_6 {"/error/syntax/section: section name is missing"};
  static const std::string err_msg_1_7_7 {"/error/syntax/section: section name is split by comment(s)"};
  static const std::string err_msg_1_7_8 {"/error/syntax/section: section name is split by newline"};
  static const std::string err_msg_1_7_9 {"/error/syntax/section: section name is unterminated"};
  static const std::string err_msg_1_8_1 {"/error/syntax/directive: directive is invalid"};
  static const std::string err_msg_1_8_2 {"/error/syntax/directive: directive is split by newline"};
  ...
  static const std::string err_msg_1_9_5 {"/error/syntax/misc: object name is non-unique in this scope" "duplicate name in scope"};
// clang-format on
